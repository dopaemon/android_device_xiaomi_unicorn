...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="unicorn-user 15 AQ3A.250226.002 OS3.0.2.0.VLECNXM release-keys" \
    BuildFingerprint=Xiaomi/unicorn/unicorn:15/AQ3A.250226.002/OS3.0.2.0.VLECNXM:user/release-keys \
